...
We recommend using [Microsoft Visual Studio Code](https://code.visualstudio.com/download) (or VS Code) as your editor as it has some useful extensions for pasting images and integrating with GitHub that can speed up your guidebook development process. VS Code is a free product.
...
|-----|------|--------|----------|
| 1.0.0 | 2019-10-31 | Chuck Tomasi | Initial release |

# Contents

This document is divided in to the following sections for easy reference:
...
1. Your workshop/lab guide must be called **guidebook<span></span>.md**.
...
1. Create an optional **files** folder for any files students need to download for the course, such as images or csv files to import. The *files* directory name is lowercase.
